...
namespace GoLocal.TimeTracker.MiddleTier.Models
{
    public class TimeTrackerOptions
    {
        ...
        public string SubmitHoursForLastMonth { get; set; }
        public string HoursRevisionRequest { get; set; }
        public string SaveHrsByDate { get; set; }
        public string FirstTimeLogin { get; set; }
        public string SubmitTeamHours { get; set; }
