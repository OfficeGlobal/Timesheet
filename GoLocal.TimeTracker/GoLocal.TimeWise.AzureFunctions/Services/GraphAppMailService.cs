...
namespace GoLocal.TimeWise.AzureFunctions.Services
{
    public class GraphAppMailService : GraphAppServiceBase
    {
        ...
        private readonly string _userObjectIdentifier;
        ...
        public async Task<List<GraphResultItem>> GetMailItemsAsync(DateTime startDate, DateTime endDate)
        {
            try
            {
                ...
                var graphResponse = await GraphAppClient.Users[_userObjectIdentifier].MailFolders.Inbox.Messages.Request(options).GetAsync();
